...
print(f"Required length: {req_length}")
...
print(f"Required: {req_length}")
print(f"Selected bolt length: {selected_length}")
...
bolt = get_bolt(conn, "M6", selected_length)
...
result = select_fastener(conn, 4, 6, "M6")
